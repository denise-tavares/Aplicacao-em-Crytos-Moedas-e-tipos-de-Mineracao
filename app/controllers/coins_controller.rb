class CoinsController < ApplicationController
  ...
  before_action :set_nining_type_options, only: [:new, :create, :edit, :update]
  ...
  private
    def set_nining_type_options
      @nining_type_options = NiningType.all.pluck(:description, :id)
    end
    ...
    def coin_params
      params.require(:coin).permit(:description, :acronym, :url_image, :nining_type_id)
    end
end
